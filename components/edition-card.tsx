 ...
 *
 * Every row here is an Invisible Garden edition of the past, and each links to
 * its recap. The upcoming Invisible Commons row was removed on 2026-09-03 when
 * the event was called off; if a next edition gets a row again, it decides its
 * own card, it does not revive the old co-hosted branch.
 */
export function EditionCard({
  ...
  return (
    ...
    >
      ...
      <p className="text-label mt-6 font-mono uppercase">Read the recap</p>
    </Link>
  );
}
